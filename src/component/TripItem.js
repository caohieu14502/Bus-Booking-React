	...
	return (
		<>
			<div className='border p-20px flex justify-between rounded-3xl w-3/4 m-auto h-[130px] shadow hover:border-indigo-500/100 hover:shadow-sm transition-shadow hover:cursor-pointer hover:shadow-indigo-400' onClick={props.onClick} key={props.key}>
				...
				<div className='fo flex flex-col justify-center w-3/6'>
					<div className='font-semibold text-lg self-center text-violet-400'>
						<Moment format='LL'>{props.setOffDay}</Moment>
						<span className='ml-2'>
				...
				<div className='flex flex-col justify-evenly items-end mr-[20px]'>
					...
					<div>
						<div className='inline-block rounded-full bg-primary px-6 pb-2 pt-2.5 text-xs font-medium leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]'>
							<span>Book me!</span>
